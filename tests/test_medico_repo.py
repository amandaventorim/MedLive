...
class TestMedicoRepo:
    ...
    # Arrange
        ...
        for i, medico in enumerate(medicos):
            ...
            assert medico.senha == lista_medicos_exemplo[i].senha, f"A senha do médico {i} obtido não corresponde à senha do médico inserido."
    ...
    def test_obter_medicos_por_pagina(self, test_db, lista_medicos_exemplo):
        ...
        for i, medico in enumerate(medicos):
            esperado = lista_medicos_exemplo[start_index + i]
            assert medico.idMedico == esperado.idMedico, f"O ID do médico {i} obtido não corresponde ao ID do médico inserido."
            assert medico.idUsuario == esperado.idMedico, f"O ID do usuário do médico {i} obtido não corresponde ao ID do médico inserido."
    ...
    def test_obter_medico_por_id(self, test_db, medico_exemplo):
        ...
        assert medico_obtido.senha == medico_exemplo.senha, "A senha do médico obtido não corresponde à senha do médico inserido."
        assert medico_obtido.genero == medico_exemplo.genero, "O gênero do médico obtido não corresponde ao gênero do médico inserido."
        assert medico_obtido.dataNascimento == medico_exemplo.dataNascimento, "A data de nascimento do médico obtido não corresponde à data de nascimento do médico inserido."
