...
from tests.conftest import item_receita_exemplo, consulta_exemplo, medicamento_exemplo, medico_exemplo, paciente_exemplo
...
class TestItemReceitaRepo:
    ...
    def test_inserir_item_receita(self, test_db, item_receita_exemplo, consulta_exemplo, medicamento_exemplo, medico_exemplo, paciente_exemplo):
        ...
        assert item_db.descricao == item_receita_exemplo.descricao, "A descrição do item de receita inserido está incorreta."
