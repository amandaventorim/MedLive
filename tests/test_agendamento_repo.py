...
class TestAgendamentoRepo:
    ...
    def test_inserir_agendamento_com_fk_inexistente(self, test_db, agendamento_exemplo):
        # Arrange
        criar_tabela_usuario()
        criar_tabela_medico()
        criar_tabela_paciente()
        criar_tabela_agenda()
        criar_tabela_agendamento()
        agendamento_exemplo.idPaciente = 9999 # ID de paciente inexistente
        agendamento_exemplo.idAgendamento = 9999 # ID de agenda inexistente
        # Act & Assert
        try:
            inserir_agendamento(agendamento_exemplo)
