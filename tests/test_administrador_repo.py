...
from tests.conftest import administrador_exemplo, usuario_exemplo
...
class TestAdministradorRepo:
    ...
    def test_obter_todos_administradores(self, test_db, lista_administradores_exemplo):
        ...
        for i, administrador in enumerate(administradores):
            ...
            assert administrador.senha == esperado.senha, f"A senha do administrador {i} obtido não corresponde ao esperado."
